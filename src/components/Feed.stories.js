...
const posts = [
  ...
  {
    'createdAt': 'Fri Dec 29 19:11:09 +0000 2017',
  ...
  {
    'createdAt': 'Fri Dec 29 19:01:00 +0000 2017',
...
storiesOf('Feed', module)
  ...
  .add('loading', () => <Feed isLoading={true}/>)
  .add('error', () => <Feed error='Cannot fetch posts from feed'/>)
